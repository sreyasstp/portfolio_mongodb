      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <div className="glass rounded-2xl p-12 text-center">
            ...
            <p className="text-white/40 mb-2">No bookmarks yet</p>
            <p className="text-sm text-white/20 mb-6">Save articles and extensions for later</p>
            <div className="flex justify-center gap-3">
              <Link href="/blog" className="btn-ghost text-sm">Browse Blog</Link>
